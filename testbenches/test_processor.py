...
async def processor_test(dut):
    ...
    cocotb.log.info(f"rst de-asserted")
    ...
    for cycle in range(100):
        ...
        cocotb.log.info(f"address stall 1 = {dut.instMem.addressstall_a.value} \n")
        cocotb.log.info(f"address stall 2 = {dut.instMem.addressstall_b.value} \n") 